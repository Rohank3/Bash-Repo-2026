...
Please refer to the [CONTRIBUTING.md](CONTRIBUTING.md) file for step-by-step instructions on making your first pull request.

## External Resources
- [Learn X in Y Minutes - Bash](https://learnxinyminutes.com/docs/bash/)
- [Linux Basics & CLI Tutorial](https://ryanstutorials.net/linuxtutorial/)
